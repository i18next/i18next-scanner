 ...
 * @see {@link http://stackoverflow.com/questions/168171/regular-expression-for-parsing-name-value-pairs} for further information.
 * @example
 * var str = ' id=nav-bar class = "top" foo = "bar\\"baz" ';
 * str.match(/([^=,\s]*)\s*=\s*((?:"(?:\\.|[^"\\]+)*"|'(?:\\.|[^'\\]+)*')|[^'"\s]*)/igm) || [];              
 * // it will show ["id=nav-bar", "class = "top"", "foo = "bar\"baz""]
 *
